...
<img style="position: absolute; width: 1280px; height: 590px; z-index: -1000;" src="${ticket.getBackgroundURL()}" alt="">
<div class="ticket created-by-anniedotexe">
  <div class="left">
    <div class="image">
      <img style="margin-bottom: -430px; z-index: -1000; height: 457px; width: 300px;" src="${ticket.getPictureURL()}" alt="">
...
">
    ...
    <p style="padding-left: 100px" class="ticket-number">${ticket.getQrCodeBillet()}</p>
  </div>
</div>
